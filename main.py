...
if __name__ == "__main__":
    ...
    parser.add_argument("-mode", dest="mode", type=str, help="Running mode")
    parser.add_argument("-Dconsole.encoding", dest="Dconsole.encoding", help="Console Encoding")
    parser.add_argument("-Dfile.encoding", dest="-Dfile.encoding", help="File Encoding")
